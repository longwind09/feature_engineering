...
public class NormMain {
    ...
    public static void main(String[] args)
        ...
        //可选参数，输入路径,默认是抽样后的路径
        String inputPath = getPath(workPath, type, conf.get("indir", DEFAULT_FILTER_DIR));
        //可选参数，输出路径，默认是离散化路径
        String outPath = getPath(workPath, type, conf.get("outdir", DEFAULT_NORM_DIR));
        ...
        String uriWithLink = filePath.toUri().toString() + "#" + NormMapper.cnfFile;
        ...
        job.setJarByClass(NormMain.class);
